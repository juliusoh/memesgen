...
const PinDetail = ({ user }) => {
  ...
  console.log("postedBy", pinDetail.postedBy);
  console.log(user._id, "gogole");
  console.log("comments", pinDetail.comments);
  console.log("pin", pinDetail);
  return (
    <>
      {pinDetail && (
                  ...
                  <div className="flex flex-col">
                    ...
                    {pinDetail.postedBy?._id === user._id && (
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          deleteComment(pinDetail._id, item._key, index);
                        }}
                        key={index}
                        className="p-3 flex items-center justify-center rounded-full bg-red-500 text-xl cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out"
                      >
                        <AiTwotoneDelete />
                      </button>
                    )}
